#ifndef SFA_BASIC_TYPES_HPP
#define SFA_BASIC_TYPES_HPP

// This is the one header that SFA assumes is available. If it isn't the user
// must provide it themselves or modify the typedefs in this file.
#include <stdint.h>
